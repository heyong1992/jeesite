...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		String classAuthor = "Hey";		// 类作者，例：ThinkGem
		...
		model.put("classAuthor", org.apache.commons.lang3.StringUtils.isNotBlank(classAuthor)?classAuthor:"Generate Tools");
		model.put("classVersion", DateUtils.getDate());
		model.put("tableName", model.get("moduleName")+(org.apache.commons.lang3.StringUtils.isNotBlank(subModuleName)
				?"_"+ org.apache.commons.lang3.StringUtils.lowerCase(subModuleName):"")+"_"+model.get("className"));
		model.put("subModuleName", org.apache.commons.lang3.StringUtils.isNotBlank(subModuleName)?"."+ org.apache.commons.lang3.StringUtils.lowerCase(subModuleName):"");
